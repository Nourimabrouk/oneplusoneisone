...
import asyncio
import socketio
from PyQt5.QtWidgets import QApplication, QWidget, QLabel, QVBoxLayout, QScrollArea, QFrame, QGraphicsView, QGraphicsScene
...
# --- Main Execution ---
async def main():
    # Initialize session data before creating tasks
    global session_data
    session_data = load_session_data()
    ...
    session_data['tasks'] = [
        {"name": "Create_Ontology_Node_1", "type": "create_ontology_node", 
         "data": {"node_id": "node1", "node_type": "concept", 
                 "properties": {"description": "First Node"}}},
        { "name": "Create_Ontology_Node_2", "type": "create_ontology_node", "data": {"node_id": "node2", "node_type": "entity", "properties": {"value": "10"}} },
        { "name": "Transform_Function_Test", "type": "unity_transform", "function_name": "add_xp" },
        ...
        { "name": "Add_Scenario_1", "type": "add_scenario", "data": { "scenario_id":"scenario_1", "events": [{"delay": 1, "function": "print('Simulating Event 1')"}] }},
        ...
        {"name":"Add_xp_from_task", "type": "add_xp", "xp_amount": 20},
         ...
         {"name": "Load_Dynamic_Module_Test", "type":"load_dynamic_module", "module_name": "test_module", "module_code": """
def test_function():
    return 'Hello from Dynamic Module'
         """},
        {"name":"Run_AI_Module_Test", "type":"run_ai_module", "module_name":"example_ai", "input_data":"This is input"},
    ...
    try:
        ...
        logging.error(f"Critical error in MetaStation: {e}")
    finally:
        if 'update_thread' in locals():
            update_thread.stop()
            update_thread.wait()
        if 'metastation' in locals():
            await metastation.shutdown()
        app.quit()
